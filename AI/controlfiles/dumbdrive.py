...
COMMAND_STALL_TIMEOUT_SEC = 1.5
COMMAND_STALL_SPEED_THRESHOLD = 0.25
COMMAND_STALL_MOVE_THRESHOLD_CM = 20.0
IMPACT_STOP_SPEED_THRESHOLD = 0.5
IMPACT_STOP_PREVIOUS_AVG_MIN = 2.0
IMPACT_STOP_MIN_DELTA = 1.5
LIDAR_CONTACT_FRONT_CM = 80.0
LIDAR_CONTACT_SPEED_THRESHOLD = 0.5
HIGH_ATTITUDE_DEG = 25.0
HIGH_ATTITUDE_SPEED_THRESHOLD = 5.0
ANGLE_SPIKE_SPEED_THRESHOLD = 7.0
...
NORMAL_DRIVE_THROTTLE = 30.0
MIN_FORWARD_DRIVE_THROTTLE = 30.0
